...
package org.kie.kogito.persistence.infinispan.inmemory.query;
...
@ApplicationScoped
public class InmemoryQueryFactoryGenerator implements QueryFactoryGenerator {
    @SuppressWarnings("unchecked")
    @Override
    public <K, V> QueryFactory generateQueryFactory(CacheDelegate<K, V> delegate) {
        return Search.getQueryFactory((Cache<K, V>) delegate.getCache());
    }
}
