...
public class StorageImpl<K, V> implements Storage<K, V> {
    ...
    private CacheListenerGenerator listenerFactory;
    private QueryFactoryGenerator queryFactoryGenerator;

    public StorageImpl(CacheDelegate<K, V> delegate, String rootType, CacheListenerGenerator listenerFactory, QueryFactoryGenerator queryFactoryGenerator) {
    ...
    public void addObjectCreatedListener(Consumer<V> consumer) {
        ...
        delegate.addClientListener(listenerFactory.generateCacheEntryCreatedListener(delegate, consumer));
    }
    ...
    public void addObjectUpdatedListener(Consumer<V> consumer) {
        ...
        delegate.addClientListener(listenerFactory.generateCacheEntryModifiedListener(delegate, consumer));
    }
    ...
    public void addObjectRemovedListener(Consumer<K> consumer) {
        ...
        delegate.addClientListener(listenerFactory.generateCacheEntryRemovedListener(delegate, consumer));
    }
