...
public class SchemaDescriptorRegisteredEvent {
    ...
    public SchemaDescriptorRegisteredEvent(String fileName, String rawSchema, FileDescriptor descriptor, Function<String, Descriptor> messageDescriptorGetter) {
    ...
    Function<String, Descriptor> getMessageDescriptorGetter() {
        return messageDescriptorGetter;
    }
